...
//  Mo
//
//  Created by 莫晓豪 on 2017/1/3.
//  Copyright © 2017年 莫晓豪. All rights reserved.
//

import UIKit

class CodedLockSetViewController: UIViewController, UIGestureRecognizerDelegate {
    ...
    func numberButtonClick(tagNumber: UIButton) {
        ...
        if (round1.backgroundColor == nil) {
            round1.backgroundColor = greenColor
        } else if (round2.backgroundColor == nil) {
            round1.backgroundColor = greenColor
            round2.backgroundColor = greenColor
        } else if (round3.backgroundColor == nil) {
            round1.backgroundColor = greenColor
            round2.backgroundColor = greenColor
            round3.backgroundColor = greenColor
        } else if (round4.backgroundColor == nil) {
            round1.backgroundColor = greenColor
            round2.backgroundColor = greenColor
            round3.backgroundColor = greenColor
            round4.backgroundColor = greenColor
        }
        ...
        if (getCodedArray.count == 4) && numberOfInput == 1 {
            ...
            infoRemindLabel2.textColor = greenColor
            ...
            getCodedArray.removeAllObjects()
            Drop.down("已设置密码锁", state: .color(greenColor), duration: 1.0)
