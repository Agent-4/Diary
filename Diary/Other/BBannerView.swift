...
public class BBannerView: UIView, UIScrollViewDelegate {
    ...
    private lazy var pageControl: UIPageControl = {
        let pc = UIPageControl(frame: CGRect(x: 0, y: 0, width: self.frame.size.width, height: 10))
        pc.center = CGPoint(x: self.frame.size.width / 2, y: self.frame.size.height - 10)
        pc.currentPageIndicatorTintColor = UIColor(red: 222/255, green: 222/255, blue: 222/255, alpha: 1)
        pc.pageIndicatorTintColor = UIColor(red: 245/255, green: 246/255, blue: 247/255, alpha: 1)
        self.addSubview(pc)
        return pc
    }()
